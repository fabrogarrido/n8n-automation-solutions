...
* 🛡️ **Prevención de Duplicados:** Implementa una lógica de `Append or Update` para mantener una base de datos limpia y sin registros repetidos.
...
* 🛠️ **Set Node (Datos limpios):** Filtra el ruido y mapea solo los campos esenciales (`Nombre`, `Email`, `Pais`).
* 💻 **Code Node (Normalización):** Script en JavaScript para la transformación y estandarización de strings.
* ⚖️ **If Node:** Cerebro lógico para la división de ramas (Aprobados vs. No aptos).
